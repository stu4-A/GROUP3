...
urlpatterns += [
    ...
    # CSV Download
    # ----------------------------
    path('lecturer/grades/download/', views.download_student_grades_csv, name='download_student_grades_csv'),
    path('lecturer/grades/download/<int:semester_id>/', views.download_student_grades_csv, name='download_student_grades_csv_semester'),
]
